...
For example, this is how @imai2022 defines these concepts:
...
::: callout-tip
Hint: I introduced the superscript $\complement$ notation, which means "complement." You can think of $C$ as "conservative" and $C^\complement$ as "not conservative."
:::
