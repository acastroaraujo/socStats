...
The probability distribution for a **Binomial** **probability distribution**, with parameters $p$ and $n = 4$ takes the following form:
...
> *---What? Did you just give me probability* $p$ it's own probability distribution?
>
> ---Yes.
