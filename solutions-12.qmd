...
$$
\frac{\Delta y}{\Delta x} = \Delta x (3691.355 − 8711.331 \cdot \Delta x)
$$

When age changes by 1 unit ( $\Delta x = 1$ ), the corresponding effect is $-5019.976$, which is the slope of the red line in the previous graph.
